...
public:
	...
	void activateCardDeath(shared_ptr<CCard> defeatedCard, vector<shared_ptr<CTable>>& tableAttacked, int randomIndex); // Method to activate the death effect of the card
};
